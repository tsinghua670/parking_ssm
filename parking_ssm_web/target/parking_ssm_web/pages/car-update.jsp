    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a
                        href="${pageContext.request.contextPath}/cars/findAll.do">车辆管理</a></li>
                <li class="active">车辆表单</li>
            </ol>
        </section>
        <!-- 内容头部 /-->

        <form action="${pageContext.request.contextPath}/cars/updateById.do"
              method="post">
            <!-- 正文区域 -->
