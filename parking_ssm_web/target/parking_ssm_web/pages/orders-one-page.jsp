                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <th class="sorting_desc sorting_desc_disabled">支付类型</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>${orders.amounts}</td>
                                    <td>${orders.orderTimeStr}</td>
                                    <td class="text-center">${orders.payTypeStr}</td>
                                    <td class="text-center">${orders.orderStatusStr}</td>
                                    <td class="text-center">${orders.desces}</td>
                                    <td class="text-center">
                                        <button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/orders/findById.do?id=${orders.id}'">详情</button>
                                        <button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/orders/findById.do?id=${orders.id}'">编辑</button>
