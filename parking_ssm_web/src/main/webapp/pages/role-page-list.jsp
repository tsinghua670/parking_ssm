                            ...
                            <c:forEach items="${pageInfo.list}" var="role">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/role/findById.do?id=${role.id}'">编辑</button>
                                        <button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/role/deleteById.do?id=${role.id}'">删除</button>
                                    </td>
                                </tr>
                            </c:forEach>
